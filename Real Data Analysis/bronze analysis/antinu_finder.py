...
def antinu_finder(energy, clockCount50, posx, posy, posz, alpha, dr_sup_lim, dr_inf_lim, energy_delay_inf_cut, energy_delay_sup_cut, file_out_name):
	...
	*Parameters:
	...
	- tau: half-time of neutron capture in the experiment. Value extracted from MC ~ 215 (mcs);
	...
	- file_out_name: directory and name to save the output dictionary with the antinu finder information of prompt and delayed events
	'''
	...
	with open(file_out_name + '.pkl', 'wb') as f:
